                    ...
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
                        ...
                        <li class="myclass0">
	                            ...
	                            <ul class="">
	                            	...
	                            	<li style="text-decoration:underline"><a href="zgbm.php">主管部门行政处罚</a></li>
...
//					                   $yhtag=$_SESSION["yhtag"];
                                        $today=date ( "Y", time () );
					                     $sql = "select 会员单位,会员标记码,id,主管部门的行政处罚 from 会员评价 where 年份='$today'" ;
									...
									<form id="bdhyform" name="bdhyform" action=" " method="post" enctype="multipart/form-data"  role="form">
										<div class="modal-body">
											<div class="form-group">
												<div class="span12">
													<label for="xzcf" class="span4">行政处罚分</label>
											<input type="text" class="span4 form-control" id="xzcf" name="xzcf" placeholder="">	
												</div>
												</div>
        ...
        $(function() {
         ...
         <script type="text/javascript">
        	...
        	function bc(){
        		var xzcf=document.getElementById("xzcf").value;
		...
		<!--<script type="text/javascript">
        	...
        	function bc1(id){
        		var xzcf1=document.getElementById("xzcf1").value;
