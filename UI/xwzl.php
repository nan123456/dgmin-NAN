                    ...
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
                        ...
                        <li class="myclass0">
	                            ...
	                            <ul class="">
	                            	...
	                            	<li style="text-decoration:underline"><a href="xwzl.php">用工实名制管理</a></li>
...
//					                   $yhtag=$_SESSION["yhtag"];
									     $today=date ( "Y", time () );
					                     $sql = "select 会员单位,会员标记码,id,用工实名制项目数,用工实名制管理  from 会员评价  where 年份='$today'" ;
									...
									<td class="center">
														<?php echo $row["用工实名制项目数"]?>						
							                         
							</td>				
							<td><?php echo $row["用工实名制管理"]?></td>
													<td class="center">
	                  	 ...
	                  	 &times;
									...
									<form id="bdhyform" name="bdhyform" action=" " method="post" enctype="multipart/form-data"  role="form">
										<div class="modal-body">
											...
											<div class="span12">
												<label for="xmsl" class="span4">项目数量</label>
								<input type="text" class="span4 form-control" id="xmsl" name="xmsl" placeholder="">							
							                          </div>
							                          </div>
       ...
       function ck(id){
        	...
        	function bc(){
        	    ...
        	    var xmsl=document.getElementById("xmsl").value;
		...
		<!--<script type="text/javascript">
        	...
        	function bc1(id){
        		var hyxz1=document.getElementById("hyxz1").value;
                 var lhxw1=document.getElementById("lhxw1").value; 
