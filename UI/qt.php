                    ...
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
                        ...
                        <li class="myclass0">
	                            ...
	                            <ul class="">
	                            	...
	                            	<li style="text-decoration:underline"><a href="qt.php">其他</a></li>
...
//					                   $yhtag=$_SESSION["yhtag"];
                                         $today=date ( "Y", time () );
					                     $sql = "select 会员单位,会员标记码,id,其他得分 from 会员评价 where 年份='$today'" ;
									...
									<form id="bdhyform" name="bdhyform" action=" " method="post" enctype="multipart/form-data"  role="form">
										<div class="modal-body">
											<div class="form-group">
												<div class="span12">
												<label for="gm" class="span4">是否被选定为观摩工地</label>
												<select id="gm" name="gm"  class="span4">
							                 ...
							                 <div class="form-group">
												<div class="span12">
												<label for="df" class="span4">其他配合事项得分</label>         
											<input type="text" class="span4 form-control" id="df" name="df" placeholder="">	
												</div>
												</div>
        ...
        <!--<script type="text/javascript">
        	...
        	function bc1(id){
        		var df1=document.getElementById("df1").value;
