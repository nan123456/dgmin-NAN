						...
						<div class="block" id="Tcontent">
							<div class="row-fluid">
								<ul class="nav navbar-inner block-header  nav-tabs" id="myUl">
									...
									<li class="active">
										<a data-toggle="tab" href="#menu3">省优质结构奖</a>
									</li>
									<li>
								...
								<div class="tab-content ">
									...
									<div id="menu3" class="tab-pane fade in active">
										...
										<div class="block-content collapse in">
						                  ...
						                  $yhtag=$_SESSION["yhtag"];
						                  if($bjm=='1'){
						                   	$sql="select * from 省优质结构奖 where 会员标记码='$yhtag'";
						                   }else if ($bjm=='2'){
						                   	$sql="select * from 省优质结构奖 where 会员标记码='$yhtag'";
						                   }else if($bjm=='3'){
						                   	$sql="select * from 省优质结构奖 where 会员标记码='$yhtag' ";
							...
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<form id="bdhyform" name="bdhyform" action="" method="post" class="" role="form">
										<input id="gcfl" value="省优质结构奖" name="gcfl" class="hidden" />
										...
										<div class="modal-body">
											...
											<div class="form-group">
												...
												<label for="gczj" class="span2 control-label">造价(万元)</label>
												<div class="span4">
													<input type="text" class="span12 form-control" id="gczj" name="gczj" placeholder="必填信息">
												</div>
											</div>
											<div class="span12">
												</div>
											...
											<?php } ?>
												...
												<label for="cs" class="span2 control-label">层数</label>
												<div class="span4">
													<input type="text" class="span12 form-control" id="cs" name="cs" placeholder="必填信息">
												</div>
												</div>
											<!--<div class="form-group">
												<label for="jd" class="span2 control-label">申报时的进度</label>
												<div class="span10">
													<input type="text" class="span12 form-control" id="jd" name="jd" placeholder="">
												</div>
											</div>-->
											<div class="span12">
												</div>
											...
											<div class="form-group">
												<label for="beizhu" class="span2 control-label">申报时的主体结构进度</label>
												<div class="span10">
									...
									<form id="bdhyform1" name="bdhyform1" action="" method="post" class="" role="form">
										...
										<div class="modal-body">
											...
											<div class="form-group">
												...
												<div class="span10">
													<input type="text" class="span12 form-control" id="xgbeizhu" name="xgbeizhu" >
												</div>
											</div>
...
//						 						alert(gcmc.value); 
		...
		<script type="text/javascript">
			...
			$("#save1").click(function() {
				...
				if(gcmc.value==""||gcdz.value==""||cjdw.value==""||cjlxr.value==""||cjlxrdh.value==""||jzsxm.value==""||jldw.value==""||zjxm.value==""||gcgm.value==""||gczj.value==""||cs.value==""||kgsj.value==""||jgsj.value==""){
					alert("请填写必填信息");
				}else{
					$.ajax({
						cache: true,
						type: "POST",
						url: 'data/syzjgjxz.php',
