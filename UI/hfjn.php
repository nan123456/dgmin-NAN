                ...
                <div class="span3" id="sidebar">
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
                        ...
                        <li class="myclass0">
	                            ...
	                            <ul class="">
	                            	<li style="text-decoration:underline"><a href="hfjn.php">会费缴纳</a></li>
...
//					                   $yhtag=$_SESSION["yhtag"];
    								$today=date ( "Y", time () );
					                     $sql = "select 会员单位,id,缴费时间,缴费金额,缴费状态,会费缴纳得分,会员性质,会员标记码  from 会员评价 where 年份='$today'" ;
							...
							<td><?php echo $row["会费缴纳得分"]?></td>
													<td class="center">
														<button type="button" id="<?php echo $row["会员标记码"];?>"  class="btn btn-primary myclass" data-toggle="modal" data-target="#myModal2" onclick="ck(this.id)">填写</button>
														</td>
						...
						<div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	                  	 ...
	                  	 &times;
									...
									<form id="bdhyform" name="bdhyform" action=" " method="post" enctype="multipart/form-data"  role="form">
										...
										<div class="span12">
											           <label for="hyxz" class="span4">会员性质</label>
								<select id="hyxz" name="hyxz"  class="span4">
													...
													<option value="会长单位">会长单位</option>
							                          ...
							                          <div class="form-group">
							                          <div class="span12">
							                          	<label for="jfsj" class="span4">缴费时间</label>
								<input type="text" class="span4 form-control" id="jfsj" name="jfsj" placeholder="例：20180601">							
							                           </div>
							                           </div>
							                           <div class="form-group">
							                           <div class="span12">
							                           	<label for="jfj2" class="span4">缴费金额</label>
								<input type="text" class="span4 form-control" id="jfj2" name="jfj2" placeholder="">							
							                           </div>
							                           </div>
        ...
        <script type="text/javascript">
        	...
        	function bc(){
        		var jfsj=document.getElementById("jfsj");
        	
        	var jfj2=document.getElementById("jfj2");
        	var hyxz=document.getElementById("hyxz");
...
// 							jfsj.value = data[i].缴费时间;
// 							hyxz.value = data[i].会员性质;
// 							jfj2.value = data[i].缴费金额;
// 								
//						}
////						 						alert(gcmc.value); 
//					},
