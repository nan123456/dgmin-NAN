                ...
                <div class="span3" id="sidebar">
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
                        ...
                        <li>	
	                            ...
	                            <ul class="">
	                            <li  style="text-decoration:underline"><a href="cygm1.php">活动报名</a></li>
						    ...
						    <div id="home" class="tab-pane fade in active">
						      ...
						      <div class="navbar navbar-inner block-header " >
						      	...
						      	<ul class="dropdown-menu">
											<li class="sx0"><a href="#bmhd" tabindex="-1" data-toggle="tab">可报名活动</a></li>
											
											<li class="sx1"><a href="#ybmhd" tabindex="-1" data-toggle="tab">已报活动</a></li>
											</ul>
											</div>
	                            </div>
						      	<div class="block-content collapse in " >
                                	<div class="span12">
                                		<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered   " id="bmhd" >
											...
											require("conn.php");
//					                   $yhtag=$_SESSION["yhtag"];
					                     $sql = "select 活动名称,活动类别,报名结束时间,id from 活动  " ;
					                 ...
					                 if($today<$a){   ?>
											...
											<td><?php echo $i++;?></td>
													...
													<td class="center">
														<button id="<?php echo $row["活动名称"];?>" type="button" class="btn btn-primary myclass7" data-toggle="modal" data-target="#myModal6" onclick="bmqy(this.id);" >
																			报名
																		</button>
													</td>
										...
										<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered fade my_none   " id="ybmhd" >
											<thead>
												<tr>
													<th>序号</th>
													<th>活动	名称</th>
					                   ...
					                   $yhtag=$_SESSION["yhtag"];
					                     ...
					                     $sql = "select 活动名称,活动类别,id,会员标记码 from 活动报名 where 会员标记码='$yhtag'" ;
					                   ...
					                   while($row = $result->fetch_assoc()) {  
					                       ?>
											...
											<td><?php echo $i++;?></td>
													...
													<td class="center">
														<button type="button" id="<?php echo $row["活动名称"];?>"   class="btn btn-primary myclass3" data-toggle="modal" data-target="#myModal3" onclick="ck(this.id);">查看
</button>
													</td>	
						...
						<div class="modal fade" id="myModal3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	                  	 ...
	                  	 &times;
										...
										<h4 class="modal-title" id="myModalLabel">活动信息查看</h4>
									</div>
        ...
        <script type="text/javascript">
         $(".sx0").click(function(){
        	$("#bmhd").removeClass("my_none");
        	$("#ybmhd").addClass("my_none");
        	  });
        	 $(".sx1").click(function(){
        	$("#ybmhd").removeClass("my_none");
        	$("#bmhd").addClass("my_none");
        	  }); 
...
//				});
				...
				<!--<script type="text/javascript">
				var gcid1=document.getElementById("gcid1");
//					var bmdw =document.getElementById("bmdw");
//					var bmrs =document.getElementById("bmrs");
//					var bmxm =document.getElementById("bmxm");
//					var bmdh =document.getElementById("bmdh");
//					var bmzw =document.getElementById("bmzw");
				function bc(){
					alert(1);
//					
//					$.ajax({
