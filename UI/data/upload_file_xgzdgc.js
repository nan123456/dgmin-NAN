...
//			url:"test_getossClient.php",
			...
			success:function(data){
				...
				*/
				//上传文件夹设定
				body = data['sign'];
				body['dir'] = body['dir'] + "\/" +"sfupload" + "\/"; //这样才得到路径：dgjx/sfupload/;"\/"指"/";
...
var uploader4 = new plupload.Uploader({//这个冲突了
	runtimes : 'html5,flash,silverlight,html4',
	browse_button : 'myfile4', 
	...
	init: {
		...
		FilesAdded: function(up, files) {
			plupload.each(files, function(file) {
				document.getElementById('ossfile4').innerHTML += '<div id="' + file.id + '">' + file.name + ' (' + plupload.formatSize(file.size) + ')<b></b>'
		...
		FileUploaded: function(up, file, info) {
            if (info.status == 200)
            {
                ...
                var furl4 = document.getElementById("furl4");
                furl4.value += geturl+"||";
