...
var uploader5 = new plupload.Uploader({//这个冲突了
	runtimes : 'html5,flash,silverlight,html4',
	browse_button : 'myfile2', 
	...
	init: {
		PostInit: function() {
			...
			//上传按钮点击事件
			document.getElementById('postfiles7').onclick = function() {
	            set_upload_param(uploader5, '', false);
	            return false;
			};
		},
		//选择文件
		...
		FileUploaded: function(up, file, info) {
            if (info.status == 200)
            {
                ...
                var furl2 = document.getElementById("furl2");
                furl2.value += geturl+"||";
