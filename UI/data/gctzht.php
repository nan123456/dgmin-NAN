...
//	$sjc=$timestr;
$sql = "INSERT INTO 市优质奖(会员标记码,工程分类,工程状态,工程名称,项目地址,申报日期,承建单位,承建联系人,承建联系人电话,建造师姓名,参建单位,参建联系人姓名,参建联系人电话,监理单位,项目总监姓名,监理联系人姓名,监理联系人电话,面积,规模,结构,上层,下层,竣工验收,备案时间,备注,Id1) values ('$hybjm','$gcfl','$gczt','$gcmc','$gcdz','$sbrq','$cjdw','$cjlxr','$cjlxrdh','$jzsxm','$cjdw1','$cjlxr1','$cjlxrdh1','$jldw','$zjxm','$jllxr','$jllxrdh','$mj','$gm','$jg','$sc','$xc','$jgg','$ys','$beizhu','$bh')";
