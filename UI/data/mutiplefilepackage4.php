...
//	 header('content-type:text/html;charset=utf-8');
	 function getFiles4(){
	 	$i=0;
		$_FILES5=array($_FILES['myfile4']);
		foreach($_FILES5 as $file){
	...
	function uploadFile4($fileInfo,$allowExt=array('jpeg','jpg','png','gif','wbmp'),$maxfile=2097152,$uploadpath='upload',$flag=true){
    if($fileInfo ['error']>0){
  	//匹配错误信息;
  	echo '失败！！！';
