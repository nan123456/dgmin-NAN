...
//					                   $cjdw=$_GET["cjdw"];
									   ...
									   if($bjm=='1'||$bjm=='2'){
					                   	 $sql = "select * from 省优秀qc  where 会员标记码='$yhtag'and 工程状态='待受理' or 承建单位='$cjdw' and 工程状态='待受理' order by Id1 asc  ";
					                   }else{
									...
									<form id="bdhyform2" name="bdhyform2" action="" method="post" class="" role="form">
										<div class="modal-body">
											...
											<div class="form-group">
												...
												<div class="span10">
													<input type="date" class="span12 form-control" id="xgsbrq4" name="xgsbrq4" placeholder="" />
												</div>
											</div>
											<div class="form-group">
						...
						<label for="sjcx" class="span1 control-label">时间查询</label>
								<div class="span4">
									...
									<input type="text" class="span2 form-control hidden" id="cjdw1" name="cjdw1" value="<?php echo $cjdw ?>">
										...
										<a href="upload/hzupload/省优秀qc.xls"><button type="button" class="" >下载</button></a>
								</div>
                                	<div class="">
  										<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="">
											<thead>
