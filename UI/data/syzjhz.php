...
//		echo gcid;
	$sqldate='';
	if($bjm1=='0'){
		 $sql = "select * from 省优质奖 where 工程状态='已受理' and 审核通过时间  between '$qssj' and '$jssj' ";
	}elseif($bjm=='1'||$bjm=='2'){
		$sql = "select * from 省优质奖  where 会员标记码='$yhtag1'and 工程状态='已受理' or 承建单位='$cjdw1' and 工程状态='已受理'  ";
   }else{
   	    $sql = "select * from 省优质奖  where 会员标记码='$yhtag1'and 工程状态='已受理' ";
   }
