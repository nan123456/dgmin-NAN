...
//	 header('content-type:text/html;charset=utf-8');
	 function getFiles5(){
	 	$i=0;
		$_FILES6=array($_FILES['myfile5']);
		foreach($_FILES6 as $file){
	...
	function uploadFile5($fileInfo,$allowExt=array('jpeg','jpg','png','gif','wbmp'),$maxfile=2097152,$uploadpath='upload',$flag=true){
    if($fileInfo ['error']>0){
  	//匹配错误信息;
  	echo '失败！！！';
