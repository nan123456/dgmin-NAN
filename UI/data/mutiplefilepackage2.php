...
//	 header('content-type:text/html;charset=utf-8');
	 function getFiles2(){
	 	$i=0;
		$_FILES3=array($_FILES['myfile2']);
		foreach($_FILES3 as $file){
	...
	function uploadFile2($fileInfo,$allowExt=array('jpeg','jpg','png','gif','wbmp'),$maxfile=2097152,$uploadpath='upload',$flag=true){
    if($fileInfo ['error']>0){
  	//匹配错误信息;
  	echo '失败！！！';
