...
//	 header('content-type:text/html;charset=utf-8');
	 function getFiles1(){
	 	$i=0;
		$_FILES2=array($_FILES['myfile1']);
		foreach($_FILES2 as $file){
	...
	function uploadFile1($fileInfo,$allowExt=array('jpeg','jpg','png','gif','wbmp'),$maxfile=2097152,$uploadpath='upload',$flag=true){
    if($fileInfo ['error']>0){
  	//匹配错误信息;
  	echo '失败！！！';
