									...
									<form id="bdhyform" name="bdhyform" action="data/syzqcxz.php" method="post" enctype="multipart/form-data"  role="form">
										...
										<div class="modal-body">
											...
											<div class="form-group">
												...
												<div class="span10">
													<input type="text" class="span12 form-control" id="xzmc" name="xzmc" placeholder="必填信息">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="span10">
													<input type="text" class="span12 form-control" id="ktmc" name="ktmc" placeholder="必填信息">
												</div>
											...
											<div class="form-group">
												...
												<div class="span10">
													<input type="text" class="span12 form-control" id="ktlx" name="ktlx" placeholder="必填信息">
												</div>
											</div>
											<!--<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="span4">
													<input type="date" class="span12 form-control" id="ktksrq" name="ktksrq" placeholder="必填信息">
												</div>
											</div>
												<div class="form-group">
												<label for="ktjsrq" class="span2 control-label">课题结束日期</label>
												<div class="span4">
													<input type="date" class="span12 form-control" id="ktjsrq" name="ktjsrq" placeholder="必填信息">
												</div>
												<div class="span12">
								                </div>
											</div>
											...
											<div class="form-group">
												...
												<div class="span10">
													<input type="text" class="span12 form-control" id="fbr" name="fbr" placeholder="必填信息">
												</div>
											</div>
											<div class="form-group">
												<label for="txdz" class="span2 control-label">通讯地址</label>
												<div class="span10">
													<input type="text" class="span12 form-control" id="txdz" name="txdz" placeholder="必填信息">
												</div>
											</div>
											<div class="form-group">
												<label for="email" class="span2 control-label">E-mail</label>
												<div class="span10">
													<input type="text" class="span12 form-control" id="email" name="email" placeholder="必填信息">
												</div>
											</div>
											<div class="form-group">
...
<!--//										<input class="hidden " id="hybjm" name="hybjm" value="<?php echo $yhtag;?>"-->
        ...
        <!--连接执行操作的js代码-->
        <script type="text/javascript" src="data/upload_file_yxqc.js"></script>
